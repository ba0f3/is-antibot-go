...
- **Upstream alignment:** detection rules and tests are manually kept in sync with [microlinkhq/is-antibot](https://github.com/microlinkhq/is-antibot) tag **`v2.0.2`** (upstream rules live in `src/providers.json`). Bump this note when you port a newer upstream release.
